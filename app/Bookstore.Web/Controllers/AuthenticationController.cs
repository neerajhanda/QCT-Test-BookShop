...
namespace Bookstore.Web.Controllers
{
    public class AuthenticationController : Controller
    {
        ...
        private ActionResult LocalSignOut()
        {
            ...
            {
                HttpContext.Response.Cookies.Append("LocalAuthentication", string.Empty, new CookieOptions { Expires = DateTime.Now.AddDays(-1) });
            }
        ...
        private ActionResult CognitoSignOut()
        {
            ...
            {
                Response.Cookies.Append(".AspNet.Cookies", string.Empty, new CookieOptions { Expires = DateTime.Now.AddDays(-1) });
            }
